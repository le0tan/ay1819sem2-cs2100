...
#Registers used: $t4 contains the address of the current minimum
#				 $t5 contains the current minimum
#				 $t6 as the loop control variable
#				 $t7 as the address of the current element
